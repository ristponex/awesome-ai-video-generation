...
|:------|:-----------|:---------|:------|:----:|:----------:|:----:|:---:|:---------|
| **Kling 3.0 Pro** | 快手 | 4K | 15秒 | ✅ | ✅ | ✅* | ❌ | $0.204/回 |
| **Kling O3 Pro** | 快手 | 4K | 15秒 | ✅ | ✅ | ✅* | ❌ | $0.204/回 |
| **Kling O1** | 快手 | 1080p | 10秒 | ✅ | ❌ | ✅* | ❌ | $0.15/回 |
| **Kling 2.6 Pro** | 快手 | 4K | 10秒 | ✅ | ✅ | ✅* | ❌ | $0.15/回 |
| **Seedance v1.5 Pro** | ByteDance | 1080p | 15秒 | ✅ | ✅ | ✅* | ❌ | $0.222/回 |
| **Seedance v1 Pro** | ByteDance | 1080p | 10秒 | ✅ | ❌ | ✅* | ❌ | $0.18/回 |
| **Wan 2.6** | Alibaba | 1080p | 15秒 | ✅ | ✅ | ❌ | ✅ | $0.07/回 |
| **Wan 2.5** | Alibaba | 1080p | 10秒 | ✅ | ❌ | ❌ | ✅ | $0.05/回 |
| **Wan 2.2 Spicy** | Alibaba | 720p | 8秒 | ❌ | ❌ | ✅ | ✅ | $0.03/回 |
| **Veo 3.1** | Google | 1080p | 8秒 | ✅ | ❌ | ❌ | ❌ | TBD |
| **Veo 3** | Google | 1080p | 8秒 | ✅ | ❌ | ❌ | ❌ | TBD |
| **Veo 2** | Google | 1080p | 8秒 | ❌ | ❌ | ❌ | ❌ | TBD |
| **Hailuo 2.3 Pro** | MiniMax | 1080p | 10秒 | ✅ | ❌ | ❌ | ❌ | TBD |
| **Hailuo 02 Pro** | MiniMax | 1080p | 10秒 | ✅ | ❌ | ❌ | ❌ | TBD |
| **Vidu Q3 Pro** | Vidu | 1080p | 8秒 | ❌ | ❌ | ❌ | ❌ | TBD |
...
> **最適な用途：** コスパ重視、オープンソース、NSFW、LoRAカスタマイズ

WanはAlibabaのオープンソースAI動画生成モデルファミリーで、市場最高のコストパフォーマンスと完全なオープンソースアクセスを提供します。
...
Wan 2.2 Spicyの**$0.03/回**が最安です。Wan 2.6は**$0.07/回**で品質と価格の最良バランスです。[Atlas Cloud](https://www.atlascloud.ai?ref=JPM683)なら初回チャージで25%ボーナス付き。
...
**まとめ：** 最高品質→Kling、音声重視→Seedance、予算/OSS→Wan

### NSFWコンテンツに最適なモデルは？

**Wan 2.2 Spicy**は$0.03/回で無検閲コンテンツに特化。[Atlas Cloud](https://www.atlascloud.ai?ref=JPM683)のKlingやSeedance向け無検閲モードも利用可能です。
